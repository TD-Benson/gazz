...
$shortcode_categories = array(
	...
	__('Icons', THEME_SLUG) => array(
		...
		'icon-align-center'	 => array(	'description' => __('Inserts an icon-align-center shortcode. [icon name=icon-align-center size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-align-center]' ),
  		...
  		'icon-windows'	 => array(	'description' => __('Inserts an icon-windows shortcode. [icon name=icon-windows size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-windows]' ),
  		'icon-android'	 => array(	'description' => __('Inserts an icon-android shortcode. [icon name=icon-android size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-android]' ),
  		'icon-linux'	 => array(	'description' => __('Inserts an icon-linux shortcode. [icon name=icon-linux size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-linux]' ),
  		'icon-dribble'	 => array(	'description' => __('Inserts an icon-dribble shortcode. [icon name=icon-dribble size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-dribble]' ),
  		'icon-skype'	 => array(	'description' => __('Inserts an icon-skype shortcode. [icon name=icon-skype size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-skype]' ),
  		'icon-foursquare'	 => array(	'description' => __('Inserts an icon-foursquare shortcode. [icon name=icon-foursquare size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-foursquare]' ),
  		'icon-trello'	 => array(	'description' => __('Inserts an icon-trello shortcode. [icon name=icon-trello size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-trello]' ),
  		'icon-female'	 => array(	'description' => __('Inserts an icon-female shortcode. [icon name=icon-female size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-female]' ),
  		'icon-male'	 => array(	'description' => __('Inserts an icon-male shortcode. [icon name=icon-male size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-male]' ),
  		'icon-gittip'	 => array(	'description' => __('Inserts an icon-gittip shortcode. [icon name=icon-gittip size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-gittip]' ),
  		'icon-sun'	 => array(	'description' => __('Inserts an icon-sun shortcode. [icon name=icon-sun size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-sun]' ),
  		'icon-moon'	 => array(	'description' => __('Inserts an icon-moon shortcode. [icon name=icon-moon size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-moon]' ),
  		'icon-archive'	 => array(	'description' => __('Inserts an icon-archive shortcode. [icon name=icon-archive size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-archive]' ),
  		'icon-bug'	 => array(	'description' => __('Inserts an icon-bug shortcode. [icon name=icon-bug size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-bug]' ),
  		'icon-vk'	 => array(	'description' => __('Inserts an icon-vk shortcode. [icon name=icon-vk size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-vk]' ),
  		'icon-weibo'	 => array(	'description' => __('Inserts an icon-weibo shortcode. [icon name=icon-weibo size=default] You can increase the size by using large, 2x, 3x, 4x', THEME_SLUG),'shortcode' => '[icon name=icon-weibo]' )
